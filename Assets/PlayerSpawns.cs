...
public class PlayerSpawns : NetworkManager {
	...
	public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
	{
		...
		if (playerCount == 1)
		{
			Car[0] = Instantiate(Resources.Load("Car9"), new Vector3(-5.73f, 0.4f, 64.33f), Quaternion.identity) as GameObject;
			Debug.Log("Player1");
		...
		if (playerCount == 3)
		{
			Car[2] = Instantiate(Resources.Load("Car2"), new Vector3(-5.73f, 0.4f, 37.3f), Quaternion.identity) as GameObject;
			Debug.Log("Player3");
