...
public class PlayerSpawns : NetworkManager {
	...
	public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
	{
		...
		if (playerCount == 1)
		{
			Car[0] = Instantiate(Resources.Load("Car7"), new Vector3(-5.73f, 0.4f, 64.33f), Quaternion.identity) as GameObject;
			Debug.Log("Player1");
		...
		if (playerCount == 2)
		{
			Car[1] = Instantiate(Resources.Load("Car6"), new Vector3(5.68f, 0.4f, 50.44f), Quaternion.identity) as GameObject;
			Debug.Log("Player2");
